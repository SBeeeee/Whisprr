...
export default function Sidebar({ active, setActive }) {
  const items = [
    ...
    { key: "taskboard",     label: "Task Board",     icon: <CheckSquare className="w-5 h-5" /> },
    { key: "projects",  label: "Projects",  icon: <Calendar className="w-5 h-5" /> },
    { key: "members", label: "Members", icon: <Bell className="w-5 h-5" /> },
    { key: "admin",   label: "Admin",icon: <PenTool className="w-5 h-5" /> },
  ];
